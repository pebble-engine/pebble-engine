  ...
  return (
    <section className="relative min-h-screen bg-pink-50 flex flex-col items-center justify-center overflow-hidden px-8 py-24">
      ...
      <div className="relative z-10 container mx-auto max-w-5xl text-center">
        {/* Eyebrow */}
        <p className="inline-flex items-center gap-2 bg-pink-100 text-pink-600 text-sm font-semibold px-5 py-2 rounded-full mb-8 tracking-wide" data-pebble-id="pb-50540d">
          After-school & weekend art classes for ages 4–12 🎨
        </p>

        {/* Headline */}
        <h1 className="text-purple-900 text-6xl md:text-8xl font-extrabold leading-none tracking-tight max-w-4xl mx-auto" data-pebble-id="pb-382f5e">
          <RevealWords>Where every kid is already an artist</RevealWords>
        </h1>

        {/* Subheadline */}
        <p className="text-purple-900/70 text-xl md:text-2xl mt-8 max-w-2xl mx-auto leading-relaxed" data-pebble-id="pb-0f7154">
          Painting, clay, collage, and gloriously messy projects in a studio that celebrates every single creation. No wrong answers — just color, imagination, and joy!
        </p>
        ...
        <div className="mt-12 flex flex-wrap gap-4 justify-center">
          ...
          <a
            href="#learn"
            className="bg-white text-purple-900 border-2 border-purple-200 px-10 py-5 rounded-full font-bold text-lg hover:scale-105 hover:border-pink-400 transition-all duration-200" data-pebble-id="pb-498bc6">
            See what's on
          </a>
        </div>
      </div>
        ...
        <div className="relative aspect-[16/9] rounded-3xl overflow-hidden shadow-2xl ring-4 ring-pink-200">
          <Parallax className="absolute inset-0" distance={40}>
            <Image
              ...
              alt="Where every kid is already an artist"
              fill
              priority
