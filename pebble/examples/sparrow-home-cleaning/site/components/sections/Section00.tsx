...
export default function HeroTradePro() {
  return (
    <section className="relative min-h-[100dvh] md:min-h-screen flex items-center overflow-hidden bg-sky-50">
      ...
      <div className="absolute inset-0">
        <Parallax className="absolute inset-0" distance={30}>
          <Image
            ...
            alt="A Spotless Home, Every Single Visit"
            fill
            priority
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-6 md:px-8 py-24 md:py-32">
        <div className="max-w-lg">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <MagneticButton
              href="#contact"
              className="inline-flex items-center justify-center bg-sky-600 text-slate-50 px-7 py-3 rounded-md font-semibold text-sm tracking-wide min-h-[44px] hover:opacity-90 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-600 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
            >
              Book Online Now
            </MagneticButton>
