  ...
  return (
    <section className="relative min-h-[100dvh] md:min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="https://images.pexels.com/photos/10827342/pexels-photo-10827342.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center flex flex-col items-center py-24 md:py-32">
        ...
        <p className="text-white/80 text-xs font-semibold uppercase tracking-[0.2em] mb-5" data-pebble-id="pb-33744c">
          Licensed & Insured · Serving Boise, ID
        </p>

        {/* Headline */}
        <h1 className="text-white text-5xl md:text-7xl font-semibold leading-tight tracking-tight" data-pebble-id="pb-71f445">
          <RevealWords>Built Right. Built to Last.</RevealWords>
        </h1>

        {/* Subheadline */}
        <p className="text-white/80 text-lg mt-6 leading-relaxed max-w-xl" data-pebble-id="pb-ff7d22">
          Whole-home remodels, additions, and outdoor living spaces — delivered on a fixed price with no surprises.
        </p>
        ...
        <div className="mt-8 pt-6 border-t border-white/20">
          <p className="text-white/70 text-xs font-medium uppercase tracking-widest" data-pebble-id="pb-d194ab">
