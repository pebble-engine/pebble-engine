    ...
    <section className="relative min-h-[100dvh] md:min-h-screen flex items-center overflow-hidden bg-slate-50">
      ...
      <div className="absolute inset-0">
        <Parallax className="absolute inset-0" distance={30}>
          <Image
            src="https://images.pexels.com/photos/33404248/pexels-photo-33404248.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
            alt="Roof Replacement & Storm Repair in Kansas City"
            fill
            priority
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-6 md:px-8 py-24 md:py-32">
        <div className="max-w-lg">
          ...
          <p className="text-sky-700 text-xs font-semibold uppercase tracking-[0.2em] mb-5" data-pebble-id="pb-d61307">
            Licensed & Insured · Serving Kansas City, MO
          </p>

          {/* Headline */}
          <h1 className="text-white text-5xl md:text-7xl font-semibold leading-tight tracking-tight" data-pebble-id="pb-b3c613">
            <RevealWords>Roof Replacement & Storm Repair in Kansas City</RevealWords>
          </h1>

          {/* Subheadline */}
          <p className="text-white/80 text-lg mt-6 leading-relaxed max-w-md" data-pebble-id="pb-d112d6">
            We handle the whole job — from free storm inspection to working directly with your insurance adjuster — so you're covered fast and correctly.
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-white/20">
            <p className="text-slate-100 text-xs font-medium uppercase tracking-widest" data-pebble-id="pb-69a543">
