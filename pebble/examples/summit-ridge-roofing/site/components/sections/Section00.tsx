  ...
  return (
    <section className="relative min-h-[100dvh] md:min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center flex flex-col items-center py-24 md:py-32">
        ...
        <p className="text-white/80 text-xs font-semibold uppercase tracking-[0.2em] mb-5" data-pebble-id="pb-35ac41">
          Licensed & Insured · Serving Kansas City, MO
        </p>

        {/* Headline */}
        <h1 className="text-white text-5xl md:text-7xl font-semibold leading-tight tracking-tight" data-pebble-id="pb-cd95d5">
          <RevealWords>Your Roof, Storm-Ready.</RevealWords>
        </h1>

        {/* Subheadline */}
        <p className="text-white/80 text-lg mt-6 leading-relaxed max-w-xl" data-pebble-id="pb-ceb4ce">
          Full replacements, storm repairs, and insurance claim help — done right, on time.
        </p>
        ...
        <div className="mt-8 pt-6 border-t border-white/20">
          <p className="text-white/70 text-xs font-medium uppercase tracking-widest" data-pebble-id="pb-f6a5c6">
