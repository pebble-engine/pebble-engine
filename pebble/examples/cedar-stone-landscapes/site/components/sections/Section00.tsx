  ...
  return (
    <section className="relative min-h-[100dvh] md:min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="https://images.pexels.com/photos/4713248/pexels-photo-4713248.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
          alt="Landscapes Built to Last"
          fill
          priority
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center flex flex-col items-center py-24 md:py-32">
        ...
        <p className="text-white/80 text-xs font-semibold uppercase tracking-[0.2em] mb-5" data-pebble-id="pb-03aee7">
          Licensed & Insured · Serving the Triangle Area
        </p>

        {/* Headline */}
        <h1 className="text-white text-5xl md:text-7xl font-semibold leading-tight tracking-tight" data-pebble-id="pb-34aded">
          <RevealWords>Landscapes Built to Last</RevealWords>
        </h1>

        {/* Subheadline */}
        <p className="text-white/80 text-lg mt-6 leading-relaxed max-w-xl" data-pebble-id="pb-cacb99">
          From custom patios to lush lawn care, we craft outdoor spaces that feel as good as they look.
        </p>
        ...
        <div className="mt-8 pt-6 border-t border-white/20">
          <p className="text-white/70 text-xs font-medium uppercase tracking-widest" data-pebble-id="pb-514ffe">
            Licensed • Insured • Free Design Consultations
          </p>
        </div>
