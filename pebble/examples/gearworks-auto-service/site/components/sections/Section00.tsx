    ...
    <section className="relative min-h-[100dvh] md:min-h-screen flex items-center overflow-hidden bg-slate-50">
      ...
      <div className="absolute inset-0">
        <Parallax className="absolute inset-0" distance={30}>
          <Image
            src="https://images.pexels.com/photos/8985450/pexels-photo-8985450.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
            alt="Honest Auto Repair for Columbus Drivers"
            fill
            priority
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-6 md:px-8 py-24 md:py-32">
        <div className="max-w-lg">
          ...
          <p className="text-sky-700 text-xs font-semibold uppercase tracking-[0.2em] mb-5" data-pebble-id="pb-cf4fd7">
            ASE-Certified & Fully Insured · Columbus, OH
          </p>

          {/* Headline */}
          <h1 className="text-white text-5xl md:text-7xl font-semibold leading-tight tracking-tight" data-pebble-id="pb-a5dcc9">
            <RevealWords>Honest Auto Repair for Columbus Drivers</RevealWords>
          </h1>

          {/* Subheadline */}
          <p className="text-white/80 text-lg mt-6 leading-relaxed max-w-md" data-pebble-id="pb-493a8b">
            From brake jobs to full diagnostics, we show you exactly what your car needs — with photos — before we touch it. Loaner cars available.
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-white/20">
            <p className="text-slate-200 text-xs font-medium uppercase tracking-widest" data-pebble-id="pb-b3db69">
