export const SITE_TITLE       = "VERDE PRESERVE | Natural-Standard Luxury Cleaning";
export const SITE_DESCRIPTION = "Plant-based, low-tox, surgical-grade restoration cleaning for estates and architectural homes. Forest-floor calm. Sage-leaf clean.";
export const BRAND_NAME       = "Verde Preserve";
export const BRAND_TAGLINE    = "The Quietest Standard of Clean";
