...
export function ServiceBento() {
  ...
  return (
    <section id="services" className="py-24 px-6 sm:px-12 md:px-20 bg-[#0f1612] relative overflow-hidden border-t border-white/5">
          ...
          {SERVICES.map((service) => {
            ...
            return (
              <button
                ...
                className={`${spanClass} text-left cursor-pointer group relative min-h-[340px] rounded-2xl overflow-hidden border border-white/5 bg-[#171f1a] p-8 md:p-10 flex flex-col justify-between transition-all duration-500`}
              >
        ...
        {active && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 w-full max-w-[460px] bg-[#121a14] border-l border-white/10 p-8 sm:p-12 z-50 overflow-y-auto"
            >
