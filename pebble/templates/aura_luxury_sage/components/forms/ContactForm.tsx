    ...
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-5" noValidate>
      <div>
        ...
        <input
          ...
          className="w-full bg-[#171f1a] border border-white/5 focus:border-white/30 outline-none text-sm font-sans text-white rounded-lg px-4 py-3 placeholder:text-slate-500 transition-colors"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full bg-[#171f1a] border border-white/5 focus:border-white/30 outline-none text-sm font-sans text-white rounded-lg px-4 py-3 placeholder:text-slate-500 transition-colors resize-none"
        />
      </div>
