  ...
  return (
    <section className="relative h-screen overflow-hidden flex flex-col items-center justify-center px-6">
      <div className="absolute inset-0 hero-zoom">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#fbf7ee]/30 via-transparent to-[#fbf7ee]/80" />
      </div>
      <motion.div
      ...
      >
        <h1 className="font-[family-name:var(--font-display)] text-5xl md:text-7xl lg:text-8xl italic font-semibold text-[#1f1a14] leading-[1.1] mb-8">
          {HERO_HEADLINE}
        </h1>
        <motion.div
          initial={{ opacity: 0 }}
