export const SITE_TITLE       = "Sage & Stone | Farm-Driven Kitchen";
export const SITE_DESCRIPTION = "A kitchen built around the herb garden out back. Heritage grains, foraged greens, and the slow art of preserving the season.";
export const BRAND_NAME       = "Sage & Stone";
