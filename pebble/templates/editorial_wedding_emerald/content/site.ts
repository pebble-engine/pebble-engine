export const SITE_TITLE       = "Emerald Hall Films | Cinematic Wedding Photography";
export const SITE_DESCRIPTION = "Jewel-toned editorial wedding photography for grand venues and old-world ceremonies. Emerald, cream, and brushed brass.";
export const BRAND_NAME       = "Emerald Hall";
