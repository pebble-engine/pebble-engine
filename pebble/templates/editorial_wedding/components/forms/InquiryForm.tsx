  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-8" noValidate>
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <label className="block text-xs uppercase tracking-widest text-[#f5f1e8]/40 mb-2">Partner One</label>
          <input type="text" name="partner_one" required placeholder="Full name" className="form-input-ed" />
        </div>
        <div>
          <label className="block text-xs uppercase tracking-widest text-[#f5f1e8]/40 mb-2">Partner Two</label>
          <input type="text" name="partner_two" required placeholder="Full name" className="form-input-ed" />
        </div>
      </div>
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <label className="block text-xs uppercase tracking-widest text-[#f5f1e8]/40 mb-2">Email</label>
          <input type="email" name="email" required placeholder="you@example.com" className="form-input-ed" />
        </div>
        <div>
          <label className="block text-xs uppercase tracking-widest text-[#f5f1e8]/40 mb-2">Wedding Date</label>
          <input type="text" name="wedding_date" required placeholder="[MM/DD/YYYY]" className="form-input-ed" />
        </div>
      </div>
      <div>
        <label className="block text-xs uppercase tracking-widest text-[#f5f1e8]/40 mb-2">Venue / Location</label>
        <input type="text" name="venue" required placeholder="[Venue Name, City]" className="form-input-ed" />
      </div>
      <div>
        <label className="block text-xs uppercase tracking-widest text-[#f5f1e8]/40 mb-2">Tell us your story</label>
      ...
      <div>
        <label className="block text-xs uppercase tracking-widest text-[#f5f1e8]/40 mb-2">How did you find us?</label>
        <select name="source" className="form-input-ed bg-[#0a0a0a]">
      ...
      {result && (
        <p className={`text-center text-sm ${result.ok ? "text-[#d4a574]" : "text-rose-400"}`}>
          {result.ok
