export const SITE_TITLE       = "[Your Studio Name] | Wedding Photography";
export const SITE_DESCRIPTION = "Editorial, cinematic wedding photography for the modern couple. Capturing quiet moments in grand spaces.";
export const BRAND_NAME       = "[Your Studio Name]";
