# ink_studio — Pebble Engine template

Gothic blackletter gold-glow Next.js 14 (App Router) template derived from the
`tattoo_studio` DNA. Placeholder brand: **Inkhouse Atelier**.
...
- Pitch-black `#0A0A0A` background, deep-gold `#C9A84C` accent, oxblood
  `#8B0000` warning spark
