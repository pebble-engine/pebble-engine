export const SITE_TITLE       = "Steel Bay Auto | Modern Diagnostic Shop";
export const SITE_DESCRIPTION = "Steel-blue modern garage. Computerized diagnostics, transparent pricing, ASE-certified mechanics. Drop-off pricing upfront.";
export const BRAND_NAME       = "Steel Bay Auto";
