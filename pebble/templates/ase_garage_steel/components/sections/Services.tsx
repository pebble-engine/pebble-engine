        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {SERVICES.map((svc, i) => (
            <Reveal key={svc.name} delay={0.03 * i}>
              <div className="group p-4 bg-[#e7e5e4]/50 hover:bg-[#3b82f6] hover:text-[#1e3a5f] transition-colors cursor-default border-2 border-transparent hover:border-[#1e3a5f] rounded-sm relative h-full">
