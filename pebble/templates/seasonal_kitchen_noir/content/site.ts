export const SITE_TITLE       = "Noir & Ember | Chef-Driven Tasting Room";
export const SITE_DESCRIPTION = "A candlelit tasting room where every plate is built around fire, smoke, and seasonal restraint.";
export const BRAND_NAME       = "Noir & Ember";
