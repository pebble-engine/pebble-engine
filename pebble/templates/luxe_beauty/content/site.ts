...
export const SITE_TITLE = "Maison Lume";
export const SITE_DESCRIPTION =
  "Maison Lume — multicultural luxury beauty. Haircare, skincare, and styling tools, meticulously crafted.";
export const TAGLINE = "Ethereal beauty. Meticulously crafted.";

// Pinyon Script cursive sub-wordmark sitting above the main wordmark in the navbar
export const WORDMARK_EYEBROW = "Maison";
export const WORDMARK_MAIN = "Lume";

// Hero
export const HERO_HEADLINE = "Where Beauty Becomes Sanctuary";
export const HERO_SUBHEADLINE =
  "A multicultural atelier of luxury haircare, skincare, and styling tools — for every shade, every texture, every story.";
export const HERO_SCRIPT_ACCENT = "for every you";
...
export const VALUES_HEADLINE = "Beauty without compromise";
export const VALUES = [
  {
    title: "Multicultural",
    description:
...
export const CATEGORIES_HEADLINE = "An atelier of objects";
export const CATEGORIES_SCRIPT_ACCENT = "lovingly assembled";
...
export const EDITORIAL_HEADLINE = "A studio in SoHo, a story in every bottle";
export const EDITORIAL_SCRIPT_ACCENT = "made by hand";
export const EDITORIAL_BODY =
  "Every Maison Lume formulation begins on a quiet bench in our SoHo atelier — botanicals weighed by the gram, tested across textures and tones, refined until they belong on a shelf you reach for first. We name nothing finished until the people who will wear it tell us it feels like theirs.";
...
export const ABOUT_SCRIPT_ACCENT = "since the beginning";
export const ABOUT_BODY = [
  "Maison Lume began as a question: why does luxury beauty so rarely arrive shaped for the people who actually wear it? We started small — a chemist, an editor, and a stylist sharing one bench in SoHo — and built the brand we wished already existed.",
  "Today we formulate, test, and finish every product in that same atelier. Our team is multicultural by design and the formulas reflect that — performance across the full range of skin tones, hair textures, and rituals.",
...
export const SHOP_INTRO =
  "Browse by category. Every product is formulated and finished in our SoHo studio.";

// Contact page
export const CONTACT_EYEBROW = "Say hello";
export const CONTACT_HEADLINE = "We'd love to hear from you";
export const CONTACT_INTRO =
  "Questions about a product, a routine, or visiting the atelier? Write to us — we read every note.";
