# luxe_beauty — Pebble Engine template

Editorial luxury-beauty Next.js 14 (App Router) template derived from the
`beauty_ethereal` DNA. Placeholder brand: **Maison Lume**.
...
- Material Design 3 surface tokens — light-mode native (mint/cream)
...
1. **Hero** — circular logo orb on ethereal mint cloud bg, italic Bodoni
