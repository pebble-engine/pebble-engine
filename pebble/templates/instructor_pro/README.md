# Instructor Pro — template

**Vibe:** Tactical Crimson Gold-Gradient. Dark, authority-forward marketing
site for any skills-instructor business — firearms training, martial arts,
personal training, executive coaching, security consulting, or other
small-group instruction verticals.

**Source DNA:** `training_authority` (see `dna_source.json`).

**Applicable industries:** firearms training · martial arts dojo · personal
trainer · executive coach · security consultant · tactical training · police
academy · first responder training · boxing gym · MMA gym · krav maga studio
· shooting range · outdoor adventure guide. Any instructor-led business where
authority + certification + small-group results are the conversion drivers.
...
`INSTRUCTOR_NAME = "[INSTRUCTOR NAME]"`) are intentional too. The
...
- Live red pulse-dot eyebrow + floating glass credentials card
- Counter-up Stats section (IntersectionObserver, respects prefers-reduced-motion)
- Course cards with widening left accent bar (4px -> 5px, gray -> red /
  amber for featured)
- Centered blockquote on radial-dots overlay (Mission section)
- Red shimmer-band animation on CTAs and offer cards
...
Internal Pebble Engine template. Brand placeholder "Stratford Tactical
Academy" is fictional — no real-business resemblance intended.
