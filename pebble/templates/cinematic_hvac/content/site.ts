...
export const SITE_DESCRIPTION = "Licensed HVAC technicians. Same-day diagnostics, written estimates, parts on the truck.";
...
export const SERVICES: Service[] = [
  { id: "svc-1", title: "AC Repair & Install",    description: "Diagnostic, repair, and full system replacement. Same-day service — our techs carry common parts on every truck.", icon: "Snowflake" },
  { id: "svc-2", title: "Heating & Furnace",      description: "Furnace tune-ups, heat pump service, emergency repairs before the next cold front. Written quote before we start.",  icon: "Flame"    },
  { id: "svc-3", title: "Indoor Air Quality",     description: "Filter upgrades, duct cleaning, humidity control. We test your air and show you the numbers, not just the invoice.", icon: "Wind"     },
];
...
export const TRUST_BADGES: Trust[] = [
  ...
  { label: "NATE CERTIFIED", sub: "North American Technician" },
...
export const CTA_BAND_BODY     = "Preventive maintenance saves you money. Book before the rush season hits.";
