...
/**
 * mix-blend-difference industrial navbar. The yellow brand tile and wordmark
 * invert against any background below (per the auto_honest_diag DNA). Adds a
 * subtle bg-card backdrop after 100px of scroll.
 */
export function Navbar() {
  ...
  // First two characters of the brand → square tile glyph (e.g. "HA").
  ...
  return (
    ...
    >
      <nav className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-4">
        ...
        >
          <span
            className="inline-flex h-8 w-8 items-center justify-center bg-primary text-bg font-mono text-xs font-bold tracking-wider"
            aria-hidden="true"
          >
            {tileGlyph}
          </span>
