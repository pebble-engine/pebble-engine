...
export const SITE_TITLE = "Beacon & Bay Realty";
export const SITE_DESCRIPTION =
  "Beacon & Bay Realty — boutique brokerage for the Northeast shoreline. Quietly negotiated. Cinematically presented.";
export const TAGLINE = "Quietly negotiated. Cinematically presented.";

// Wordmark — the navbar logo is an 8x8 vermilion square mark + uppercase wordmark.
export const WORDMARK_MARK = "B"; // single character rendered inside the accent square
export const WORDMARK_MAIN = "Beacon & Bay";

// Hero
export const HERO_EYEBROW = "Boutique brokerage";
export const HERO_HEADLINE_LINE_1 = "FIND YOUR";
export const HERO_HEADLINE_LINE_2 = "SHORELINE";
export const HERO_SUBHEADLINE =
  "A small bench of advisors representing the Northeast coast — Sag Harbor to Newport — where every acquisition is private, deliberate, and quietly done.";
...
export const PRINCIPAL_BODY =
  "Beacon & Bay was founded as a deliberately small bench. We don't operate by volume; we operate by trust. Every introduction is hand-warmed, every showing is by appointment, and every contract is read across a table — never across a portal.";
...
export const ADDRESS_LINE_2 = "Sag Harbor, NY";
...
export const ABOUT_BODY = [
  "Beacon & Bay was assembled on the principle that boutique brokerage is not a size — it is a posture. We say no to listings every week so that the inventory we represent is exactly what we'd want our own families to live in.",
  "Our advisors live where they work. They walk the docks at Sag Harbor in October, drive the back roads of Litchfield in March, and know which carpenter in Newport answers the phone on a Sunday. That isn't an expertise you can scale.",
