...
export const SITE_TITLE = "Harbor Stone Holdings";
export const SITE_DESCRIPTION =
  "Harbor Stone Holdings — boutique brokerage for the Northeast yacht-club coast. Quietly significant properties. Discreetly transacted.";
export const TAGLINE = "Quietly significant properties.";

// Wordmark — the navbar logo is an 8x8 brass square mark + uppercase wordmark.
export const WORDMARK_MARK = "H"; // single character rendered inside the accent square
export const WORDMARK_MAIN = "Harbor Stone";

// Hero
export const HERO_EYEBROW = "Boutique brokerage";
export const HERO_HEADLINE_LINE_1 = "FIND YOUR";
export const HERO_HEADLINE_LINE_2 = "HARBOR";
export const HERO_SUBHEADLINE =
  "A small bench of advisors representing the Northeast yacht-club coast — Greenwich to Newport — where every acquisition is private, deliberate, and quietly done.";
...
export const INTRO_HEADLINE_LINE_1 = "PRECISION";
export const INTRO_HEADLINE_LINE_2 = "TERRITORY.";
...
export const PRINCIPAL_BODY =
  "Harbor Stone was founded as a deliberately small bench. We don't operate by volume; we operate by trust. Every introduction is hand-warmed, every showing is by appointment, and every contract is read across a table — never across a portal.";
...
export const ADDRESS_LINE_2 = "Greenwich, CT";
...
export const ABOUT_BODY = [
  "Harbor Stone was assembled on the principle that boutique brokerage is not a size — it is a posture. We say no to listings every week so that the inventory we represent is exactly what we'd want our own families to live in.",
  "Our advisors live where they work. They walk the seawall at Greenwich in October, drive the back roads of Litchfield in March, and know which boatwright in Newport answers the phone on a Sunday. That isn't an expertise you can scale.",
  "We are not the largest brokerage on the shore, and we will never try to be. Every transaction we close is one we hand-shepherded from the first cup of coffee to the closing-day key exchange.",
];
