export const SITE_TITLE       = "Lavender Lane Dental | Calm Practice for Every Age";
export const SITE_DESCRIPTION = "A quiet, lavender-soft dental practice for nervous patients, sensitive kids, and anyone tired of clinical fluorescents. Slow appointments. Honest answers.";
export const BRAND_NAME       = "Lavender Lane Dental";
