...
export function Hero() {
  return (
    <section className="bg-[#1e293b] min-h-[90vh] flex items-stretch">
      <div className="grid grid-cols-1 md:grid-cols-2 w-full">
        <div className="p-12 md:p-20 flex flex-col justify-center space-y-8">
          <Reveal>
            <span className="text-[#facc15] uppercase text-xs tracking-[0.2em] font-bold mb-4 block">
              {HERO_PILL}
            </span>
        ...
        <div className="relative min-h-[300px] md:min-h-0">
          ...
          />
          <div className="absolute bottom-6 left-6 bg-[#1e293b]/90 px-4 py-2 border-l-2 border-[#facc15]">
