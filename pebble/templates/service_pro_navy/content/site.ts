...
export const SITE_TITLE = "Meridian Service Co";
export const SITE_DESCRIPTION =
  "Trusted pest, lawn, and home services across the North Shore. Professional. Precise. Insured.";
export const TAGLINE = "Professional. Precise. Insured.";

// Hero copy
export const HERO_HEADLINE_TOP = "Professional.";
...
export const PROCESS_STEPS: ProcessStep[] = [
  ...
  },
  {
    ...
    description:
      "Licensed, insured technicians apply targeted treatments only where they're needed. No blanket spraying.",
  },
  {
    step: 3,
...
export const ABOUT_BODY = [
  "Meridian Service Co is a small team of licensed technicians who treat your property the way we'd treat our own. We're independently owned and operated, which means decisions get made by people who actually pick up the phone.",
...
// Footer
export const FOOTER_TAGLINE = "Professional service. Long Island.";
