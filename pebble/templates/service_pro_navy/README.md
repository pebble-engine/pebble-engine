# Service Pro (Navy) — template

**Vibe:** Deep Slate Navy Dual-Theme. Dark-by-default service-industry marketing
site with a crisp light-slate light mode, glass-morphism navbar, three blurred
glow orbs behind the hero, an infinite marquee, and a shimmer-swept "Call Now"
chip above the phone number. Color variant of `service_pro` for a more
corporate / B2B-leaning feel.
...
that wants a more corporate / professional voice.
...
Internal Pebble Engine template. Brand placeholder "Meridian Service Co" is
