    ...
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-6" noValidate>
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            required
            className="w-full bg-[#2a1810]/80 border border-[#e7e5e4]/20 p-3 text-[#fafaf9] focus:border-[#d97444] focus:outline-none transition-colors"
          />
        </div>
        <div>
      ...
      <div>
        ...
        <textarea
          ...
          required
          className="w-full bg-[#2a1810]/80 border border-[#e7e5e4]/20 p-3 text-[#fafaf9] focus:border-[#d97444] focus:outline-none transition-colors resize-none"
        />
      </div>
      ...
      {result && (
        <p className={`text-center text-sm ${result.ok ? "text-[#d97444]" : "text-[#fb7185]"}`}>
