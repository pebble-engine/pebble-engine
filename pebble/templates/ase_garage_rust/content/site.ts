export const SITE_TITLE       = "Rust Belt Auto | Honest Mechanic, Old-School Garage";
export const SITE_DESCRIPTION = "Honest diagnostics, no upsells. ASE-certified mechanics in a warm brick-and-rust garage. Drop-off pricing upfront.";
export const BRAND_NAME       = "Rust Belt Auto";
