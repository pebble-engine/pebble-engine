# Honest Garage — template

**Vibe:** Industrial Hazard-Stripe Stencil. Dark-by-default mechanic / auto-repair
marketing site with a fixed-top 4px yellow-and-black diagonal hazard stripe,
JetBrains Mono ref-code labels on every section, hollow-stencil section
headings, and a parts-catalog feel for the service list.

**Source DNA:** `auto_honest_diag` (see `dna_source.json` and
`pebble/templates/dna/auto_honest_diag.json`).

**Applicable industries:** auto repair · mechanic / garage · tire shop · auto
body / collision · construction · industrial supply · welding · machine shop ·
heavy equipment rental · trucking / logistics · industrial electrician ·
industrial plumbing · warehouse services · tool & equipment rental · concrete
contractor. Any blue-collar trade where the buyer wants HONEST + COMPETENT
signals over flashy marketing.
...
- **Hazard stripe** — a 4px-tall fixed-top `repeating-linear-gradient(45deg)`
  yellow/black bar above the nav. The industrial tell.
...
- **Yellow accent** — `#FFD200` accent on a near-black `#1A1A1A` background,
  used sparingly for CTAs, ref codes, and the photo corner tags.
...
Internal Pebble Engine template. Brand placeholder "Honest Axle Auto" is
