export const SITE_TITLE       = "Sage Family Dental | Calm Modern Dentistry";
export const SITE_DESCRIPTION = "Calm sage-toned dentistry for every age. No upsells. No rushing. Quiet rooms, gentle hands, honest answers.";
export const BRAND_NAME       = "Sage Family Dental";
