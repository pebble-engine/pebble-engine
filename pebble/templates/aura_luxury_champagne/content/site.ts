export const SITE_TITLE       = "MAISON CHAMPAGNE | Hospitality Restoration & Concierge Care";
export const SITE_DESCRIPTION = "Warm-luxury restoration cleaning and concierge care for boutique hotels, private clubs, and estate residences. Champagne-gold standards. Cognac warmth.";
export const BRAND_NAME       = "Maison Champagne";
export const BRAND_TAGLINE    = "Warm Luxury, Quietly Tended";
