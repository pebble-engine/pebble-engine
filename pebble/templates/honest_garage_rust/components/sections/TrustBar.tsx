...
/**
 * Four-badge trust grid. Each card has its BADGE-0X ref code in warm-amber
 * accent above the badge name. Stagger entrance per DNA motion vocabulary (100ms each).
 */
