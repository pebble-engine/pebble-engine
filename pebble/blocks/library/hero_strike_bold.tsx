    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-{{bg}}">
      ...
      <div className="relative z-10 container mx-auto px-8 py-24 max-w-6xl">
        ...
        <div className="mt-12 flex flex-wrap gap-4 items-center">
          <a
            href="#start"
            className="bg-{{accent}} text-{{bg}} px-10 py-4 rounded-md font-black uppercase tracking-widest text-sm hover:scale-105 hover:bg-{{fg}} hover:text-{{bg}} transition-all duration-150"
          >
            {{cta_primary}}
          </a>
          <a
