 ...
 *
 * Phase 55.1 — added Google + GitHub OAuth origins to connect-src,
 * frame-src, and form-action so login flows don't break under CSP.
 *
 * Phase 56a — added maps.google.com to frame-src for the Google Maps
 ...
 *   - Google + GitHub for OAuth
 *   - Google Maps for integration embeds
