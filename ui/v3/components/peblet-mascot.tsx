  ...
  return (
    ...
    >
      ...
      <img
        ...
        draggable={false}
      />
      {/* peblet-face.png is the circle-cropped face-only variant
          generated by scripts/crop_peblet.py. The full-body PNG
          (peblet.png) stays in the folder for any future
          context where the limbs + posture matter (mascot-on-page
          illustrations, marketing renders). */}
      <style>{`
