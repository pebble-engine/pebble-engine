# Website Build Brief -- Vinnys Plumbing
...
- **Business name:** Vinnys Plumbing
- **Type of business:** plumbing
- **Location / service area:** Suffolk County, NY
- **Primary visitor action:** business presence (hours, location, contact); lead capture / contact form; online booking / appointments
- **Booking or payment system:** Booking: Housecall

---

## 2. Visual Reference & Inspiration

*(No reference site provided. Infer aesthetic direction from the emotional direction and visual experience settings above, and from the business category in the Business Intelligence skill.)*

---

## 3. Visitor Experience Direction

**How visitors should feel:** Calm and comfortable
**Visual experience level:** Smooth and professional
...
*(No extra context -- use the business intelligence skill to fill in industry best practices.)*
...
**Use these Unsplash placeholder images in your build:**

- **Hero:** `https://source.unsplash.com/1600x900/?professional,plumber,working`
- **Service 1:** `https://source.unsplash.com/800x600/?plumbing,tools,close-up`
- **Service 2:** `https://source.unsplash.com/800x600/?pipe,repair,work`
- **Service 3:** `https://source.unsplash.com/800x600/?water,fixture,installation`
- **Team 1:** `https://source.unsplash.com/600x600/?professional,portrait,business`
- **Team 2:** `https://source.unsplash.com/600x600/?professional,portrait,business,portrait`

**Important:**
- Use these exact URLs in your `<img src="...">` tags
- Do NOT use local paths like `/images/hero.jpg`
- These are high-quality placeholders that make the site look real
- Document all images in TODO_ASSETS.md so client knows to replace with real photos
